...
return (
    // FIX: Contenedor wrapper con max-height calculado para ~3 filas (3 * 12rem + gaps)
    // Se añade overflow-y-auto para el slider y un ligero padding derecho para que el scroll no monte las tarjetas.
    <div className="max-h-[40rem] overflow-y-auto overflow-x-hidden pr-2 -mr-2 scroll-smooth">
