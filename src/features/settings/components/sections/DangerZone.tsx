...
import { AlertCircle, Trash2, RefreshCcw, Download } from 'lucide-react';
    ...
    return (
        <Card className="rounded-2xl shadow-sm border-destructive/20 bg-destructive/5 overflow-hidden">
            ...
            <CardContent className="space-y-4">
                {/* Export Data Section */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-xl border border-primary/20 bg-primary/5 shadow-sm gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Descarga un archivo Excel con toda tu información financiera.</p>
                        </div>
                    </div>
                ...
                {/* Operational Data Deletion Section */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-xl border border-destructive/10 bg-white shadow-sm gap-4">
                    <div className="flex items-center gap-3">
                    ...
                    <AlertDialog>
                        <AlertDialogTrigger asChild>
                            <Button
                                variant="outline"
                                size="sm"
                                className="w-full sm:w-[220px] text-destructive border-destructive/30 hover:bg-destructive/10 font-medium"
                            >
